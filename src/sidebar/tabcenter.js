...
export default class TabCenter {
  ...
  _applyTheme(theme) {
    ...
    const tabActiveBackground = style.getPropertyValue("--tab-active-background");
    if (background !== "" && tabActiveBackground !== "" && isLight(background)) {
      style.setProperty("--background", tabActiveBackground);
      style.setProperty("--tab-active-background", background);
    }
  }
